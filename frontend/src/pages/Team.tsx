...
import type { LeaderboardRow, Role, User } from '../lib/types'
      ...
      <form onSubmit={submit} noValidate className="space-y-4">
        ...
        <Field label="Role">
          <Select
            ...
            options={[
              { value: 'employee', label: 'User — record quotes and log activity' },
              { value: 'admin', label: 'Admin — everything, including managing the team' },
            ]}
          />
        </Field>
